...
There are multiple ways to model the correlation relationship between GDP and CO2. However, a great factor in the increase of CO2 emissions is the onslaught of the Industrial Revolution, with some countries starting as early as the 19th century.

We sought to evaluate the changing relationship between average country GDP per capita and CO2 emissions per capita by fitting our obsercations with a linear regression model: both for overall averages in the dataset and for incremental averages from each decade, starting from 1930, from when a majority of the world has already industrialized, to 2010, the present day.
